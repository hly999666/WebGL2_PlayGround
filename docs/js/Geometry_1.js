 let simpleVertexShader =/*glsl*/ `#version 300 es
in vec4 a_position;
in vec2 a_texcoord;
in vec3 a_normal;
...
let specularVertexShader =/*glsl*/  `#version 300 es
in vec4 a_position;
in vec3 a_normal;
...
let normalShader = /*glsl*/`#version 300 es
...
let textureShader = /*glsl*/ `#version 300 es
precision highp float;
...
let specularShader = /*glsl*/  `#version 300 es
...
function main() {
    ...
    const texInfo = loadImageAndCreateTextureInfo("./texture/uv-grid.png", render);
